...
NguberMember.controller('RideRequest_EnrouteController', [
  '$rootScope',
  '$scope',
  '$state',
  '$stateParams',
  '$interval',  
  'rideRequest',
  function ($rootScope, $scope, $state, $stateParams, $interval, rideRequest) {
    var map = null;
    ...
    checkState();
    $rootScope.checkEnrouteTimer = $interval(function () {
      checkState();                
    },
    5000);
    ...
    $scope.$on('$destroy', function() {
      if (angular.isDefined($rootScope.checkEnrouteTimer)) {
        $interval.cancel($rootScope.checkEnrouteTimer);
